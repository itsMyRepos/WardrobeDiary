...
public class DryCleanDataAdapter extends RealmRecyclerViewAdapter<WardrobeItemUri, DryCleanDataAdapter.MyViewHolder> {
    ...
    public DryCleanDataAdapter(Context activity, OrderedRealmCollection<WardrobeItemUri> data, boolean headerRequired, boolean cbList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dryclean_adapter_layout, parent, false);
    ...
    View.OnLongClickListener onlongclickListner=new View.OnLongClickListener() {
        ...
        public boolean onLongClick(View view) {
            ...
            ((DryCleanActivity) context).updateAdapter();
...
//            headerLayout=(RelativeLayout)itemView.findViewById(R.id.title_layout);
            checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    if (longClick) {
                        ((DryCleanActivity) context).refreshMenu();
                    }
