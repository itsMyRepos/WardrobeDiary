...
public class WebActivity extends AppCompatActivity {
    ...
    private String postUrl = "http://www.mensxp.com/fashion/shoes/40682-shahid-kapoor-just-wore-3-shoes-that-are-driving-us-crazy-like-crazy.html";
...
//        imgHeader = (ImageView) findViewById(R.id.backdrop);
    ...
    private void openInAppBrowser(String url) {
        Intent intent = new Intent(WebActivity.this, BrowserActivity.class);
